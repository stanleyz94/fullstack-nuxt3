<template>
    <form>
      ...
      <div>
        ...
        <textarea v-model="data.description" id="message" rows="4" class="lock p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:bg-neutral-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Question description"></textarea>
      </div>
