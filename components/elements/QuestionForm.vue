    ...
    <form>
      ...
      <div class="flex justify-end">
        <button @click="postQuestion" type="button"
          class="mt-5 text-white bg-gradient-to-r from-teal-500 via-teal-600 to-teal-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
          Ask Question
        </button>
