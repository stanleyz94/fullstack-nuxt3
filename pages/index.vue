  ...
  <div class="theme-mode from-white to-green-200 dark:bg-black">
    ...
    >
      <div class="text-center">
        <h1
          class="text-4xl font-bold tracking-tight dark:text-white text-gray-900 sm:text-5xl md:text-6xl"
        >
          <span class="block xl:inline">Ask a question</span>
          <span class="block text-green-600 xl:inline"> in Question Board</span>
        </h1>
        <p
          class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:text-lg md:mt-5 md:text-xl lg:mx-0"
        >
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc feugiat,
          enim eget suscipit congue, elit leo varius lectus, nec dictum mi elit
          vel tortor. Mauris egestas, massa vitae euismod ornare, mauris tellus
          cursus leo, eget consequat purus lorem nec ex. Proin in elementum
          quam, ac varius lacus. Sed elementum enim nec aliquam scelerisque.
        </p>
