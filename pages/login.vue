      ...
      <div class="flex items-center justify-center  px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
          <div>
            ...
            <h1 class="py-9 text-center text-5xl font-extrabold text-gray-900 dark:text-gray-400">Question Board</h1>
            </div>
          ...
          <form v-if="true" v-on:submit.prevent class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <a href="#" class="font-medium text-teal-600 hover:text-green-500 dark:text-white"> Forgot your password? </a>
              </div>
            </div>
  
            <div>
              <button @click.prevent="postLoginForm"
                class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-400 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
