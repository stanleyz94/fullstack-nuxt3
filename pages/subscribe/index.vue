<template>
  <div class="min-h-screen from-white to-blue-200 dark:bg-black">
      ...
      >
        <div class="relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12">
          ...
          <div class="relative p-6 space-y-6 lg:p-8">
            <h3
              class="text-3xl text-gray-700 dark:text-white font-semibold text-center"
            >
              Premium Membership
            </h3>
            <div>
              <div class="relative flex justify-around">
                <div class="flex items-end">
                  <span
                    class="text-8xl text-gray-800 dark:text-white font-bold leading-0"
                    >10</span
                  >
                  <div class="pb-2">
                    <span
                      class="block text-2xl text-gray-700 dark:text-white font-bold"
                      >&euro;</span
                    >
                  </div>
                </div>
            ...
            <ul
              role="list"
              class="w-max space-y-4 py-6 m-auto text-gray-600 dark:text-white"
            >
              <li class="space-x-2">
            ...
            <form v-else action="/api/subscribe" method="POST">
              <input
                type="hidden"
                name="lookup_key"
                value="price_1L3kuDHeYNYuGUgN8m1fVuMM"
              />
